 ...
 */
final class Version20190808070957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE labels (id INT AUTO_INCREMENT NOT NULL, vir_local_number_id INT NOT NULL, location_id INT DEFAULT NULL, login_id INT DEFAULT NULL, local_label VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, location_date DATETIME DEFAULT NULL, INDEX IDX_B5D102115CB2E05D (login_id), INDEX IDX_B5D10211CFDC10B6 (vir_local_number_id), INDEX IDX_B5D1021164D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE locations (id INT AUTO_INCREMENT NOT NULL, agency_id INT DEFAULT NULL, location VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, free_place TINYINT(1) NOT NULL, driveway VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_17E64ABACDEADB2A (agency_id), UNIQUE INDEX UNIQ_17E64ABA5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE order_back (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, status TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, company_id INT DEFAULT NULL, agency_id INT DEFAULT NULL, order_back_id INT DEFAULT NULL, ordering_number VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, vir_local_number VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, customer_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, date_entry DATETIME NOT NULL, delivry_date DATE NOT NULL, labels INT NOT NULL, statuts TINYINT(1) NOT NULL, INDEX IDX_E52FFDEE979B1AD6 (company_id), INDEX IDX_E52FFDEE1F2296BB (order_back_id), INDEX IDX_E52FFDEEA76ED395 (user_id), INDEX IDX_E52FFDEECDEADB2A (agency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE product_listing (id INT AUTO_INCREMENT NOT NULL, order_number_id INT NOT NULL, family_product_id INT NOT NULL, product_number VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_1AD95364764EB525 (family_product_id), INDEX IDX_1AD953648C26A5E8 (order_number_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE storages (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, location_id INT DEFAULT NULL, login_id INT DEFAULT NULL, location_date DATETIME DEFAULT NULL, INDEX IDX_3AEE41A564D218E (location_id), INDEX IDX_3AEE41A54584665A (product_id), INDEX IDX_3AEE41A55CB2E05D (login_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE order_back');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
